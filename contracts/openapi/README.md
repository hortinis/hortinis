...
synchronization walking skeleton and the contract-first anchored reconciliation endpoints selected by
G1. G2 through G4 implement the production policy adapters. Garden resources and unresolved
authentication contracts remain outside this contract.
